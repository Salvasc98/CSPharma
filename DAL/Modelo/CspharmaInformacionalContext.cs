...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Server=localhost;Port=5432;Database=cspharma_informacional;User Id=postgres;Password=Admin1234");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<TdcCatEstadosDevolucionPedido>(entity =>
        {
            ...
            entity.HasIndex(e => e.CodEstadoDevolucion, "tdc_cat_estados_devolucion_pedido_cod_estado_devolucion_key").IsUnique();
        ...
        modelBuilder.Entity<TdcCatEstadosEnvioPedido>(entity =>
        {
            ...
            entity.HasIndex(e => e.CodEstadoEnvio, "tdc_cat_estados_envio_pedido_cod_estado_envio_key").IsUnique();
        ...
        modelBuilder.Entity<TdcCatEstadosPagoPedido>(entity =>
        {
            ...
            entity.HasIndex(e => e.CodEstadoPago, "tdc_cat_estados_pago_pedido_cod_estado_pago_key").IsUnique();
        ...
        modelBuilder.Entity<TdcCatLineasDistribucion>(entity =>
        {
            ...
            entity.HasIndex(e => e.CodLinea, "tdc_cat_lineas_distribucion_cod_linea_key").IsUnique();
        ...
        modelBuilder.Entity<TdcTchEstadoPedido>(entity =>
        {
            ...
            entity.HasOne(d => d.CodEstadoDevolucionNavigation).WithMany(p => p.TdcTchEstadoPedidos)
                ...
                .HasConstraintName("tdc_tch_estado_pedidos_fkey");
            ...
            entity.HasOne(d => d.CodEstadoEnvioNavigation).WithMany(p => p.TdcTchEstadoPedidos)
                ...
                .HasConstraintName("tdc_tch_estado_pedidos_cod_estado_envio_fkey");
            ...
            entity.HasOne(d => d.CodEstadoPagoNavigation).WithMany(p => p.TdcTchEstadoPedidos)
                ...
                .HasConstraintName("tdc_tch_estado_pedidos_cod_estado_pago_fkey");
